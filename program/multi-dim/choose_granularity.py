...
class choose_granularity_beta:
    ...
    def get_2_way_granularity_for_HDG_2(self, ep = None):
        n = self.args.user_num
        # k = self.args.attribute_num + self.args.attribute_num * (self.args.attribute_num - 1) // 2         # d + Cd2
        k = (self.args.attribute_num * (self.args.attribute_num - 1) // 2) / (1 - self.args.user_alpha)      # Cd2/(1-alpha)
